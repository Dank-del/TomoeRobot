...
from TomoeRobot import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
from TomoeRobot.modules.translations.strings import tld, tld_help 
...
An [anime](https://telegra.ph/file/454c5d754062b80264055.jpg) themed fork of [TomoeRobot Aya](https://gitlab.com/HarukaNetwork/OSS/HarukaAya)
